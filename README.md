...
| 📊 **個股分析(短線)** | **即時報價**(交易時間每15秒自動更新)、綜合評分+雷達圖、互動 K 線圖、**基本面**(EPS/毛利率/ROE/營收趨勢/本益比評價/配息)、**籌碼面**(三大法人+外資持股+累計買賣超+融資券趨勢+券資比+券商分點)、實戰回測、部位計算、**個股新聞** |
...
| `realtime.py` | 個股即時報價(證交所 MIS,交易時間每15秒更新) |
